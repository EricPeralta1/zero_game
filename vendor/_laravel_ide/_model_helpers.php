...
namespace App\Models {
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Seccion> $Seccion
     * @property-read int|null $Seccion_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\puntuacion> $Puntaciones
     * @property-read int|null $Puntaciones_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Illuminate\Notifications\DatabaseNotification> $notifications
     * @property-read int|null $notifications_count
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereIdUser($value)
     ...
     * @property string $nombre_juego
     * @property int $id_game
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\puntuacion> $Usuario
     * @property-read int|null $Usuario_count
     * @method static \Illuminate\Database\Eloquent\Builder<juego>|juego whereIdGame($value)
     * @method static \Illuminate\Database\Eloquent\Builder<juego>|juego whereNombreJuego($value)
     * @method static \Illuminate\Database\Eloquent\Builder<juego>|juego whereDescripcion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<juego>|juego whereInstrucciones($value)
    ...
    /**
     * App\Models\puntuacion
     *
     * @property string|null $fecha
     * @property int|null $id_game
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion whereIdPuntuacion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion wherePuntos($value)
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion whereTiempoNivel($value)
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion whereVidas($value)
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion whereErrores($value)
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion whereIdUser($value)
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion whereIdGame($value)
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion whereFecha($value)
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<puntuacion>|puntuacion query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class puntuacion extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int $id_rol
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Usuario> $Usuario
     * @property-read int|null $Usuario_count
